...
          <Link href="/login">
          <motion.a
            className="rounded-full bg-purple-800 px-6 py-3 font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-purple-900"
...
          <Link href="/signup">
            <motion.a
              className="rounded-full border-2 border-purple-800 px-6 py-3 font-semibold text-purple-800 transition-all duration-300 hover:bg-purple-800 hover:text-white"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
