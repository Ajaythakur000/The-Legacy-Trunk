...
// Variants for a buttery-smooth fade-in animation
...
export default function Home() {
  ...
  // This function sets the state based on which button is clicked
  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-white">
      ...
      >
        ...
        >
          <motion.button
            onClick={() => handleOpenModal(true)} // This button opens the Login modal
          ...
          <motion.button
            onClick={() => handleOpenModal(false)} // This button opens the Sign Up modal
      ...
      {/* Auth Modal with AnimatePresence for exit animations */}
      <AnimatePresence>
        {showModal && <AuthModal isVisible={showModal} onClose={() => setShowModal(false)} isLogin={isLoginModal} />}
      </AnimatePresence>
    </div>
  );
}