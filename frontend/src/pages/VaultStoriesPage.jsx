...
function ComicStickers() {
  return (
    <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', zIndex: 0, overflow: 'hidden' }}>
      ...
      <motion.div animate={{ rotate: [0, -10, 0] }} transition={{ repeat: Infinity, duration: 5 }} style={{ position: 'absolute', top: '40%', right: '8%', fontSize: 50, filter: 'drop-shadow(4px 4px 0px #3E2723)' }}>✂️</motion.div>
    ...
    <div style={{ minHeight: '100vh', padding: '40px 20px 80px', position: 'relative', overflowX: 'hidden' }}>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', position: 'relative', zIndex: 10 }}>
        ...
        <motion.div initial={{ opacity: 0, y: -30 }} animate={{ opacity: 1, y: 0 }} transition={{ type: 'spring', bounce: 0.5 }} style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: 48, color: '#FDFBF7', letterSpacing: 2, margin: '0 0 10px' }}>
            ADD A MEMORY
          </h1>
        ...
        {!activeCircleId ? (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} style={{ background: '#FFF', border: '6px solid #3E2723', borderRadius: 24, padding: '60px 40px', textAlign: 'center', boxShadow: '16px 16px 15px 0px rgba(0,0,0,0.45)' }}>
            ...
            <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: 32, color: '#A0522D', margin: '0 0 10px' }}>NO FAMILY SELECTED!</h3>
