  ...
  return (
    <div style={{ maxWidth: '850px', margin: '0 auto', padding: '40px 20px' }}>
      ...
      <div style={{ marginBottom: '40px', paddingBottom: '20px', borderBottom: '6px solid #3E2723' }}>
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: '48px', color: '#632020', textShadow: '4px 4px 0px #3E2723', WebkitTextStroke: '2px #3E2723', margin: '0 0 12px 0', letterSpacing: '2px' }}>
          SEARCH RESULTS
        </h1>
        <p style={{ fontFamily: "'Baloo 2', sans-serif", fontWeight: 700, fontSize: '18px', color: '#3E2723', margin: 0, background: '#D4B895', display: 'inline-block', padding: '4px 12px', border: '1px solid #3E2723', borderRadius: 8, boxShadow: '4px 4px 15px 0px rgba(0,0,0,0.3)' }}>
          HUNTING FOR: <span style={{ color: '#632020' }}>"{query}"</span>
        </p>
      </div>
      ...
      {loading ? (
        ...
        <motion.div initial={{ scale: 0.9 }} animate={{ scale: 1 }} style={{ textAlign: 'center', padding: '80px 20px', background: '#FFF', borderRadius: '24px', border: '6px solid #3E2723', boxShadow: '12px 12px 15px 0px rgba(0,0,0,0.3)' }}>
