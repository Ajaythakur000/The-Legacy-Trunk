  ...
  return (
    <div style={{ 
      ...
      <motion.div 
        ...
        style={{ 
          background: '#FFFFFF', border: 'none', borderRadius: '16px', padding: '40px', 
          maxWidth: '440px', width: '100%', textAlign: 'center', boxShadow: '12px 12px 15px 0px rgba(0,0,0,0.45)' 
        }}
      >
        <div style={{ fontSize: '64px', marginBottom: '16px' }}>💥</div>
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 36, color: '#1E352F', textShadow: '2px 2px 0px #3E2723', WebkitTextStroke: '1px #3E2723', margin: '0 0 12px 0' }}>
          OH SNAP!
        </h2>
        ...
        <Link to="/dashboard" style={{ textDecoration: 'none' }}>
          <motion.button 
            whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95, x: 4, y: 4, boxShadow: '0px 0px 15px 0px rgba(0,0,0,0.45)' }}
            style={{ 
              background: '#C89B3C', border: 'none', color: '#3E2723', 
              padding: '16px 24px', borderRadius: '12px', fontFamily: "'Playfair Display', serif", fontSize: 20, 
              boxShadow: '6px 6px 15px 0px rgba(0,0,0,0.45)', cursor: 'pointer', width: '100%', transition: 'box-shadow 0.1s' 
            }}
          >
            BACK TO BASE
          </motion.button>
