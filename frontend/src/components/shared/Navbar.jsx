...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  ::-webkit-scrollbar-thumb { background: #632020; border: 1px solid #3E2723; }
  ...
  .lt-sidebar {
    ...
    box-shadow: 8px 0px 15px 0px rgba(0,0,0,0.3);
  }
  ...
  .lt-sb-brand-name { display:block; font-family:'Playfair Display', serif; font-size:18px; color:#632020; text-shadow: 2px 2px 0px #3E2723; WebkitTextStroke: 1px #3E2723; }
  .lt-sb-user { display:flex; align-items:center; gap:10px; padding:8px 10px; background:#FFF; border: 1px solid #3E2723; border-radius:12px; cursor:pointer; transition:all 0.2s; box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3); }
  .lt-sb-user:hover { transform: translate(-2px, -2px); box-shadow: 6px 6px 15px 0px rgba(0,0,0,0.3); }
  .lt-sb-avatar { width:36px; height:36px; border-radius:50%; flex-shrink:0; background:#8B5A2B; display:flex; align-items:center; justify-content:center; font-family:'Playfair Display', serif; font-size:16px; color:#3E2723; border: 1px solid #3E2723; }
  ...
  .lt-sb-online { width:12px; height:12px; border-radius:50%; background:#00C853; border:2px solid #3E2723; flex-shrink:0; margin-left:auto; }
  ...
  .lt-sb-link:hover { background:#8B5A2B; border: 1px solid #3E2723; box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3); transform: translate(-2px, -2px); }
  .lt-sb-link.lt-active { background:#D4B895; border: 1px solid #3E2723; box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3); }
  .lt-sb-icon { width:32px; height:32px; border-radius:8px; flex-shrink:0; background:#FFF; border:2px solid #3E2723; display:flex; align-items:center; justify-content:center; font-size:16px; }
  ...
  .lt-sb-badge { font-family:'Playfair Display', serif; font-size:12px; background:#632020; border:2px solid #3E2723; color:#FFF; border-radius:8px; padding:2px 8px; margin-left:auto; flex-shrink:0; }
  .lt-sb-foot { margin-top:auto; padding:16px; border-top:4px solid #3E2723; background: #8B5A2B; }
  .lt-sb-logout { display:flex; align-items:center; gap:10px; padding:10px; border-radius:12px; cursor:pointer; background:#FFF; width:100%; border: 1px solid #3E2723; transition:all 0.2s; box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3); }
  .lt-sb-logout:hover { background:#632020; color:#FFF; transform: translate(-2px, -2px); box-shadow: 6px 6px 15px 0px rgba(0,0,0,0.3); }
  ...
  .lt-ham-btn {
    ...
    color:#3E2723; flex-shrink:0; box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3);
  }
  .lt-ham-btn:hover { transform:translate(-2px,-2px); box-shadow: 6px 6px 15px 0px rgba(0,0,0,0.3); }
  .lt-ham-btn:active { transform:translate(2px,2px); box-shadow: 0px 0px 15px 0px rgba(0,0,0,0.3); }
  ...
  .lt-header-brand-name {
    ...
    color:#632020; letter-spacing:1px; text-shadow: 2px 2px 0px #3E2723;
  ...
  .lt-search-form {
    ...
    box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3); position:relative;
  }
  .lt-search-form:focus-within { transform:translate(-2px,-2px); box-shadow: 6px 6px 15px 0px rgba(0,0,0,0.3); width: 300px; }
  ...
  .lt-oracle-btn:hover { width:150px; padding:5px 14px 5px 5px; transform:translate(-2px,-2px); box-shadow: 6px 6px 15px 0px rgba(0,0,0,0.3); }
  .lt-oracle-btn:active { transform:translate(2px,2px); box-shadow: 0px 0px 15px 0px rgba(0,0,0,0.3); }
  .lt-oracle-icon { width:28px; height:28px; border-radius:8px; display:flex; align-items:center; justify-content:center; font-size:18px; flex-shrink:0; background:#FFF; border:2px solid #3E2723; }
  ...
  .lt-hub-btn {
    ...
    background:#D4B895; border: 1px solid #3E2723; border-radius:12px;
    cursor:pointer; transition:all 0.1s; height:44px;
    box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3);
  }
  .lt-hub-btn:hover, .lt-hub-btn.lt-open { transform:translate(-2px,-2px); box-shadow: 6px 6px 15px 0px rgba(0,0,0,0.3); }
  .lt-hub-btn:active { transform:translate(2px,2px); box-shadow: 0px 0px 15px 0px rgba(0,0,0,0.3); }
  ...
  /* ── Dropdowns ── */
  .lt-dark-dropdown {
    background:#FFF; border: 2px solid #3E2723; border-radius:16px;
    box-shadow: 8px 8px 15px 0px rgba(0,0,0,0.3); overflow:hidden; min-width:240px; padding:12px; position:relative;
  }
  ...
  .lt-dd-item:hover { background:#8B5A2B; border: 1px solid #3E2723; box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3); transform:translate(-2px,-2px); }
  .lt-dd-item.lt-dd-active { background:#D4B895; border: 1px solid #3E2723; box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3); }
  ...
  .lt-icon-btn {
    ...
    position:relative; box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3);
  }
  .lt-icon-btn:hover { background:#632020; transform:translate(-2px,-2px); box-shadow: 6px 6px 15px 0px rgba(0,0,0,0.3); }
  .lt-icon-btn:active { transform:translate(2px,2px); box-shadow: 0px 0px 15px 0px rgba(0,0,0,0.3); }
  .lt-notif-badge { position:absolute; top:-6px; right:-6px; background:#D4B895; color:#3E2723; font-family:'Playfair Display', serif; font-size:12px; width:22px; height:22px; border-radius:50%; display:flex; align-items:center; justify-content:center; border: 1px solid #3E2723; }

  /* ── Streak wrap ── */
  .lt-streak-wrap {
    display:flex; align-items:center; gap:8px; padding:6px 14px;
    background:#FFF; border: 1px solid #3E2723; border-radius:12px;
    height:44px; cursor:default; box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3);
  }
  ...
  .lt-avatar-btn {
    ...
    background:#8B5A2B; border: 1px solid #3E2723; cursor:pointer;
    display:flex; align-items:center; justify-content:center;
    box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3); transition:all 0.1s; overflow: hidden;
  }
  .lt-avatar-btn:hover { transform:translate(-2px,-2px); box-shadow: 6px 6px 15px 0px rgba(0,0,0,0.3); }
  .lt-avatar-btn:active { transform:translate(2px,2px); box-shadow: 0px 0px 15px 0px rgba(0,0,0,0.3); }
  ...
  .lt-profile-box { min-width:260px; background:#FFF; border: 2px solid #3E2723; border-radius:16px; box-shadow: 8px 8px 15px 0px rgba(0,0,0,0.3); overflow:hidden; }
  .lt-profile-head { padding:16px; border-bottom:4px solid #3E2723; display:flex; align-items:center; gap:12px; background: #8B5A2B; }
  .lt-profile-avatar { width:46px; height:46px; border-radius:12px; flex-shrink:0; background:#FFF; display:flex; align-items:center; justify-content:center; font-family:'Playfair Display', serif; font-size:18px; color:#3E2723; border: 1px solid #3E2723; overflow:hidden; }
  ...
  .lt-profile-link:hover { background:#D4B895; border: 1px solid #3E2723; box-shadow: 4px 4px 15px 0px rgba(0,0,0,0.3); transform:translate(-2px,-2px); }
  .lt-profile-link.lt-danger:hover { background:#632020; color:#FFF; }
          ...
          <header className="lt-top-header">
            ...
            <div className="lt-nb-left">
              ...
              <div className="lt-header-brand lt-desktop-only">
                ...
                <div style={{width: 44, height: 44, background: '#D4B895', borderRadius: '50%', border: '1px solid #3E2723', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden'}}>
                  ...
                  {isNotifOpen && (
                    <motion.div style={{position:'absolute',top:'calc(100% + 12px)',right:0,zIndex:100}}
                      ...
                      <div className="lt-dark-dropdown" style={{width: 320, padding: 0}}>
                        <div className="lt-dd-header" style={{background:'#8B5A2B', margin: 0, padding: '16px'}}>ALERTS!</div>
                                ...
                                <div style={{flex:1}}>
                                  ...
                                  {isInvite && !notif.isRead && (
                                    <div style={{display:'flex',gap:8,marginTop:10}}>
                                      <button onClick={e=>{e.stopPropagation();handleAcceptInvite(notif._id);}} style={{background:'#00C853', color:'#FFF', border: '1px solid #3E2723', borderRadius: 8, padding: '6px 12px', fontFamily:"'Playfair Display', serif", cursor:'pointer'}}>YES</button>
                                      <button onClick={e=>{e.stopPropagation();handleRejectInvite(notif._id);}} style={{background:'#632020', color:'#FFF', border: '1px solid #3E2723', borderRadius: 8, padding: '6px 12px', fontFamily:"'Playfair Display', serif", cursor:'pointer'}}>NO</button>
                                    </div>
                                  )}
                                </div>
                              </div>
