...
const GLOBAL_CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .lt-sb-brand-name { display:block; font-family:'Playfair Display', serif; font-size:18px; color:#1E352F; text-shadow: 2px 2px 0px #3E2723; WebkitTextStroke: 1px #3E2723; }
  ...
  .lt-header-brand-name {
    ...
    color:#1E352F; letter-spacing:1px; text-shadow: 2px 2px 0px #3E2723;
