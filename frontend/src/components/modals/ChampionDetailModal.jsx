...
function StatBar({ label, value, max = 100, color = '#8B5A2B', delay = 0 }) {
  ...
  return (
    <div style={{ marginBottom: 12 }}>
      ...
      <div style={{ height: 16, background: '#FFF', borderRadius: 8, border: '1px solid #3E2723', overflow: 'hidden', boxShadow: '2px 2px 15px 0px rgba(0,0,0,0.3)' }}>
        <motion.div
          initial={{ width: 0 }}
          animate={{ width: `${pct}%` }}
      ...
      >
        ...
        <motion.div
          ...
          style={{
            ...
            overflow: 'hidden', boxShadow: '16px 16px 15px 0px rgba(0,0,0,0.3)',
          }}
        >
          {/* Close Button */}
          <button
            ...
            style={{
              ...
              background: '#632020', border: '2px solid #3E2723', color: '#FFF',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              cursor: 'pointer', fontFamily: "'Playfair Display', serif", fontSize: 20,
              boxShadow: '4px 4px 15px 0px rgba(0,0,0,0.3)', transition: 'transform 0.1s'
            }}
          >✕</button>
          ...
          <div className="lt-custom-scrollbar" style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', position: 'relative' }}>
            ...
            <div style={{ padding: '40px 24px 24px', background: '#D4B895', borderBottom: '6px solid #3E2723', textAlign: 'center', position: 'relative' }}>
              ...
              <div style={{ position: 'absolute', top: 16, left: 16, background: '#8B5A2B', border: '1px solid #3E2723', padding: '4px 12px', borderRadius: 8, fontFamily: "'Playfair Display', serif", fontSize: 14, boxShadow: '2px 2px 15px 0px rgba(0,0,0,0.3)', transform: 'rotate(-5deg)' }}>
                #1 CHAMPION 👑
              </div>

              {/* Avatar Box */}
              <div style={{ width: 110, height: 110, margin: '20px auto 16px', borderRadius: '50%', background: '#FFF', border: '2px solid #3E2723', overflow: 'hidden', boxShadow: '6px 6px 15px 0px rgba(0,0,0,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                {avatar ? (
              ...
              <div style={{ display: 'inline-block', background: '#632020', color: '#FFF', border: '1px solid #3E2723', padding: '4px 16px', borderRadius: 8, fontFamily: "'Playfair Display', serif", fontSize: 14, boxShadow: '2px 2px 15px 0px rgba(0,0,0,0.3)', transform: 'rotate(2deg)' }}>
                TOP HISTORIAN
              </div>
            </div>
            ...
            <div style={{ padding: '24px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10, marginBottom: 24 }}>
                {[
                  ...
                  { label: 'LIKES', value: likes, color: '#632020', icon: '❤️' },
                  { label: 'STREAK', value: streak, color: '#8B5A2B', icon: '⚡' },
                ].map((s, i) => (
                  <div key={i} style={{ background: s.color, border: '1px solid #3E2723', borderRadius: 12, padding: '12px 8px', textAlign: 'center', boxShadow: '4px 4px 15px 0px rgba(0,0,0,0.3)' }}>
              ...
              {/* Progress bars */}
              <div style={{ background: '#F5F5F5', border: '1px solid #3E2723', borderRadius: 16, padding: 16, boxShadow: '4px 4px 15px 0px rgba(0,0,0,0.3)' }}>
                <StatBar label="STORY POWER" value={stories} max={100} color="#D4B895" delay={0} />
                <StatBar label="COMMUNITY LOVE" value={likes} max={200} color="#632020" delay={0.1} />
                <StatBar label="FIRE STREAK" value={streak} max={30} color="#8B5A2B" delay={0.2} />
              </div>
              ...
              <div style={{ marginTop: 24 }}>
                <motion.button
                  onClick={onClose}
                  whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.95, x: 2, y: 2, boxShadow: '0px 0px 15px 0px rgba(0,0,0,0.3)' }}
                  style={{
                    width: '100%', padding: '16px', background: '#00C853',
                    border: '2px solid #3E2723', borderRadius: 12, color: '#FFF',
                    fontFamily: "'Playfair Display', serif", fontSize: 20, cursor: 'pointer',
                    boxShadow: '6px 6px 15px 0px rgba(0,0,0,0.3)', textShadow: '2px 2px 0px #3E2723'
                  }}
                >
                  AWESOME! 💥
                </motion.button>
