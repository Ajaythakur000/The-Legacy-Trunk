  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        {/* ── 1. OUTER SHELL (Fixed Boundaries) ── */}
        <motion.div
          key="cdm-card"
          ...
          style={{
            ...
            /* OUTER SHELL HIDES EVERYTHING THAT GOES OUTSIDE */
            overflow: 'hidden', 
            boxShadow: '0 0 0 1px rgba(212,168,80,0.05), 0 30px 80px rgba(0,0,0,0.8), 0 0 60px rgba(212,168,80,0.08)',
          }}
        >
          {/* ── FIXED OVERLAYS (Lines & Corners) ── */}
          {/* Top shimmer */}
          <div style={{ position: 'absolute', top: 0, left: '15%', right: '15%', height: 1, background: 'linear-gradient(90deg,transparent,rgba(212,168,80,0.75),transparent)', zIndex: 20 }}/>
          {/* Bottom shimmer */}
          <div style={{ position: 'absolute', bottom: 0, left: '15%', right: '15%', height: 1, background: 'linear-gradient(90deg,transparent,rgba(212,168,80,0.25),transparent)', zIndex: 20 }}/>

          {/* Corner Accents (Fixed in outer shell) */}
          {[
            ...
            <div key={i} style={{ position: 'absolute', width: 18, height: 18, borderColor: 'rgba(212,168,80,0.55)', borderStyle: 'solid', zIndex: 20, pointerEvents: 'none', ...s }}/>
          ))}
            ...
            >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 10, marginBottom: 22 }}>
                {[
                  ...
                  { label: 'Active Days', value: streak,  icon: '⚡', color: '#a78bfa' },
                ].map((s, i) => (
                  <motion.div key={i}
      ...
      <style>{`
        ...
        /* 🔥 Custom scrollbar styling for the inner content */
        .lt-custom-scrollbar::-webkit-scrollbar {
            width: 4px;
        }
        .lt-custom-scrollbar::-webkit-scrollbar-track {
            background: transparent;
        }
        .lt-custom-scrollbar::-webkit-scrollbar-thumb {
            background: rgba(212,168,80,0.3);
            border-radius: 10px;
        }
        .lt-custom-scrollbar::-webkit-scrollbar-thumb:hover {
