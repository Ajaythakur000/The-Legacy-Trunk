      ...
      >
        <div style={S.card}>
          ...
          <div style={{ marginBottom: 24, position: 'relative', zIndex: 2 }}>
            <h2 style={{ margin: '0 0 4px', fontSize: 32, color: '#D4B895', textShadow: '3px 3px 0px #3E2723', WebkitTextStroke: '1px #3E2723' }}>
              WELCOME BACK!
            </h2>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', position: 'relative', zIndex: 2 }}>
            ...
            <p style={{ margin: '20px 0 0', fontWeight: 700, fontSize: 15, color: '#3E2723' }}>
              New here?{' '}
              <Link to="/signup" style={{ color: '#D4B895', textDecoration: 'underline', fontFamily: "'Playfair Display', serif", fontSize: 18 }}>
                JOIN NOW
              </Link>
            </p>
          </form>
